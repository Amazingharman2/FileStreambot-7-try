...
#---------------------[ START CMD ]---------------------#
@FileStream.on_callback_query(filters.regex(r"^(home|help|about|N/A|close|msgdelete|msgdelyes|msgdelpvt|msgdelpvtyes|mainstream|userfiles|myfile|sendfile)_"))

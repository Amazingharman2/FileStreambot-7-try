...
class Telegram:
    ...
    OWNER_ID = int(env.get('OWNER_ID', 'None'))
    WORKERS = int(env.get("WORKERS", "6"))  # 6 workers = 6 commands at once
    DATABASE_URL = str(env.get('DATABASE_URL'))
    UPDATES_CHANNEL = str(env.get('UPDATES_CHANNEL', "botio_devs"))
    UPDATES_CHANNEL_LINK = "https://t.me/botio_devs"
    SESSION_NAME = str(env.get('SESSION_NAME', 'FileStream'))
    FORCE_SUB_ID = -1002054575318
    FORCE_SUB = env.get('FORCE_UPDATES_CHANNEL', False)
    FORCE_SUB_LINK = "https://t.me/+q9VjOJzWyOMzMDJl"
